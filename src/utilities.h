...
#ifndef THE_DOOMED_SHIP_UTILITIES_H
#define THE_DOOMED_SHIP_UTILITIES_H
...
InputType get_value_in_range(const InputType &min, const InputType &max, const std::string &prompt,
...
#endif //THE_DOOMED_SHIP_UTILITIES_H
