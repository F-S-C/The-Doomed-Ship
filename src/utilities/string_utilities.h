...
#ifndef THE_DOOMED_SHIP_STRING_UTILITIES_H
#define THE_DOOMED_SHIP_STRING_UTILITIES_H
...
public:
     ...
     */
    explicit colored_string(const std::string &str, PrintColors foreground = PrintColors::RED,
                   PrintColors background = PrintColors::BLACK);
...
#endif //THE_DOOMED_SHIP_STRING_UTILITIES_H
